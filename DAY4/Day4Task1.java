...
public class Test1Test {
  ...
  public void test1() {
    ...
    driver.manage().window().setSize(new Dimension(893, 850));
    ...
    driver.findElement(By.id("input-email")).sendKeys("harishm052003@gmail.com");
    driver.findElement(By.id("input-password")).click();
    driver.findElement(By.id("input-password")).sendKeys("Harishm@05");
